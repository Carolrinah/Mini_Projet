            ...
            <div class="row justify-content-around">
               ...
               <tr>
 			    <th>Contenu</th>
   				 ...
   				 <th>DateContenu</th>
   				 <th>titre</th>
           <th><b><a href="add.php">Ajouter Contenu</th></a></b>
   				</tr>
      <?php 
 		...
 		<td><p><?php echo $contenu['Contenu'] ?></p></li></td>
 			...
 			<td><button class="button button5"><a href="delete.php?idContenu=<?php echo $contenu['idContenu']?>">Supprimer</button></a>
 		
 			<td><button class="button button5"><a href="modification.php?idContenu=<?php echo $contenu['idContenu']?>">Modifier</button></a></td>
 		</tr>
 			<?php } 
  ?>
</table>
